...
# Change to data path
start_idx=1000 # starting point of the forward transient

# Solver for three regions
n1=3000           # forward transient
n2=4000           # steps in the interval
n3=4000           # backward transient

# base_type='State'
# os.chdir('/home/shashank/Documents/Data Assimilation/ENKF_for_CLVs/data/L96/L96-{}/state/'.format(model_dim))
# base_traj=np.load('Multiple_trajectories_N=1_gap={}_ti=0.0_tf=500.0_dt_{}_dt_solver={}.npy'.format(dt,dt,dt_solver))[start_idx:]

# base_type='state_noisy'
# sigma=0.5
# os.chdir('/home/shashank/Documents/Data Assimilation/ENKF_for_CLVs/data/L96/L96-{}/sigma={}'.format(model_dim,sigma))
# base_traj=np.load('{}_g={}_sigma={}.npy'.format(base_type,dt,sigma))[start_idx:]
...
base_traj=np.load('filter_mean.npy'.format(dt,mu))[start_idx:]
...
# Moving over the transient part
